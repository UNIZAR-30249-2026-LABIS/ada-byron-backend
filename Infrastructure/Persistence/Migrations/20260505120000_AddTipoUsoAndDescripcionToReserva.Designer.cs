...
namespace AdaByron.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260505120000_AddTipoUsoAndDescripcionToReserva")]
    partial class AddTipoUsoAndDescripcionToReserva
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdaByron.Domain.Aggregates.ReservationAggregate.Reserva", b =>
                {
                    ...
                    b.Property<DateTime>("FechaEstadoModificado")
            ...
            modelBuilder.Entity("AdaByron.Domain.Aggregates.SpaceAggregate.Espacio", b =>
                {
                    ...
                    b.OwnsOne("AdaByron.Domain.Aggregates.SpaceAggregate.Planta", "Planta", b1 =>
                        {
                            b1.Property<string>("EspacioCodigoEspacio")
                                .HasColumnType("character varying(20)");
